...
const GettingStarted = () => {
    return (<>
        ...
        <div className="min-h-screen text-gray-700 flex justify-center pb-32 items-center">
            ...
            <div className="relative z-10 font-['Georgia'] flex flex-col justify-center items-center space-y-4 px-4 pr-8 text-gray-950">
                ...
                <div className='flex flex-col justify-center items-center space-y-4'>
                    ...
                    <Link to="/register" className="bg-gray-800 text-white px-9 py-5 rounded-lg font-['Cinzel'] font-medium text-2xl hover:bg-orange-800 transition-colors">Create Your First Post</Link>
        ...
        <div className="flex flex-col items-center mt-8">
            <h1 className="text-8xl font-['Georgia']">How it works?</h1><br />
            <iframe
                className="w-11/12 md:w-3/4 lg:w-1/2 xl:w-1/2 h-64 md:h-96"
                src="https://www.youtube.com/embed/1he_Izj8AHc"
